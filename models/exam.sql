...
`like_count` int NULL DEFAULT 0 COMMENT '每次点赞+2',
`comment_count` int NULL DEFAULT 0 COMMENT '每次评论+3',
`facorite_count` int NULL DEFAULT 0 COMMENT '每次收藏+4',
PRIMARY KEY (`id`) 
);
...
`explains` varchar(255) CHARACTER SET utf8 NULL COMMENT '答案解释',
`url` varchar(255) CHARACTER SET utf8 NULL COMMENT '试题图片',
